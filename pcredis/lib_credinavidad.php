...
$txttippag = (substr($tipper,0,1)== 'O') ? '20 cuotas semanales' : '10 cuotas quincenales';
...
<!--                                    <span>" . $txttippag . " y 2 especiales</span><br>-->
                ...
                <table width=90% height=100% border=0 cellspacing=0 align=center>
                  <tr>
                        ...
                        MONTO REQUERIDO <br>
                          <p><input type=radio name=mon value=500000 ". (($val == 500000)?'checked':'') ."/>500.000,00</p>
                        </td>
                        <td align=center>
                        MODO DE PAGO <br>
...
<!--                          <p align=left><input type=radio name=opc value=1 ". (($sel == 0)?'checked':'') ."/>".$txttippag." Y 1 CUOTA SEMESTRAL</p>-->
                        </td>
                ...
                <table width=100% height=100% border=0 cellspacing=0>
                  ...
                  <tr>
                        ...
                        <h4>
                                ...
                                <br>
				CONSIGNAR EN SOBRE CERRADO O CARPETA ETIQUETADOS
                                <br><br>
...
public static function aceptaryprocesar($ced, $raiz, $rdir, $url, $docr) {
        ...
        $contenido .= count(glob("/srv/www/htdocs/DEF_CREDINAVIDAD_*.TXT"));
...
//echo "ejecutando definitivo " . date("h:i:sa") . "<br>";
        ...
        $file_socio = $raiz . $rdir . "DEF_CREDINAVIDAD_".$ced.".TXT";
        escribir_archivo($file_socio, $contenido);

//ob_end_clean();
//        $ejec = exec($raiz . $rdir . "ejec_pvx_credinavidad resta 2>&1");
